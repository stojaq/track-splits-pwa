    ...
    <aside id="sidebarMenu" class="fixed top-0 left-0 h-full w-72 bg-white dark:bg-dark-bg border-r border-gray-100 dark:border-dark-border z-[70] transform -translate-x-full transition-transform duration-300 shadow-2xl flex flex-col">
        ...
        <div class="p-4 flex-grow overflow-y-auto">
            <nav class="flex flex-col gap-2">
                ...
                <a href="${basePath}/pages/minimi.html" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${window.location.pathname.includes('minimi') ? 'bg-primary-50 text-primary-600 dark:bg-primary-900/20 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300'} font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v5s3 0 3-5M12 15c-3 0-3 5-3 5s3 0 3-5M16 7h3a2 2 0 012 2v2a2 2 0 01-2 2h-3M8 7H5a2 2 0 00-2 2v2a2 2 0 002 2h3"/><circle cx="12" cy="7" r="4"/></svg>
                    Minimi Italiani
                </a>
                ...
                <a href="${basePath}/pages/curiosita.html" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${window.location.pathname.includes('curiosita') ? 'bg-primary-50 text-primary-600 dark:bg-primary-900/20 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300'} font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/><path d="M22 12a10 10 0 1 1-20 0 10 10 0 0 1 20 0z"/></svg>
                    Curiosità
                </a>
                <a href="${basePath}/pages/eventi.html" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${window.location.pathname.includes('eventi') ? 'bg-primary-50 text-primary-600 dark:bg-primary-900/20 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300'} font-medium">
